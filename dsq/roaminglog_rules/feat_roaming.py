...
# os.chdir('/data1/bss_roaminglog/code/')
...
def feat_roam_day(df):
    ...
    del df_feat_merge['caller_isdn']
    del df_feat_merge['called_isdn']
...
if __name__ == '__main__':
    ...
    print(df_feat_day.info())

# python feat_roaming.py -input_data 'file' -output_data 'file' -day 20190313
